...
Even though I had an undergraduate degree in a non STEM (Science, Technology, Engineering, Mathematics) program, I was able to get into the graduate program in AI.  I have a history in computers dating back to my first computer which was an IBM PS/2 in the late 80s (1980s).  I have been programming off and on since then, and have always been interested in building PCs and technology in general. I have two Microsoft certifications also, both in Windows Server technology.  I also had to take three pre-requisite classes to be admitted into the graduate program, which were all computer programming related.